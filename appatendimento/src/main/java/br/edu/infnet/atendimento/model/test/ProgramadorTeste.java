...
public class ProgramadorTeste implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
        ...
        AppImpressao.relatorio("Inclusão do Programador 1", p1);
        ...
        AppImpressao.relatorio("Inclusão do Programador 2", p2);
        ...
        AppImpressao.relatorio("Inclusão do Programador 3", p3);
